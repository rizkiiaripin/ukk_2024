...
<div class="card mb-4">
    ...
    <div class="card-body">
            <?php 
                   ...
                   $id = $_GET['id'];
                   $data = new Anggota();
                   foreach ($data->tampilAnggotaSingle($id) as $tampil) {
                   ?>
        ...
        <td>
            ...
            <div class="form-floating mb-3">
                <input type="text" value="<?php echo $tampil['id_anggota'];?>" class="form-control" id="floatingInput" name="txtid" placeholder="Id buku" required disabled>
            ...
            <div class="form-floating mb-3">
                <input type="text" value="<?php echo $tampil['nm_anggota'];?>" class="form-control" id="floatingInput" name="txtnama" placeholder="tahun penerbit" required>
            ...
            <div class="form-floating mb-3">
               <textarea class="form-control" id="floatingInput" name="txtalamat" required><?php echo $tampil['alamat_anggota'];?></textarea>
                <label for="floatingInput">Alamat</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" value="<?php echo $tampil['telp_anggota'];?>" class="form-control" id="floatingInput" name="txttelepon" placeholder="Nama pengarang" required >
...
if (isset($_POST['bsimpan'])) {
   ...
   $telepon = $_POST['txttelepon'];
        ...
        $data = new Anggota();
        $data->editAnggota($id,$user,$status,$pass,$nama,$gender,$alamat,$telepon);
        echo"<script>
        alert( 'data diedit');
